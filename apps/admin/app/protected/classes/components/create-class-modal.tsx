...
export function CreateClassModal({
  ...
  const [programType, setProgramType] = useState<"stock_game" | "finance_sim">("stock_game");
  ...
  const startGameDataGeneration = async (params: {
    ...
    const { classId, totalDays, selectedStocks, createdClass, resultMessage } =
      params;
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (programType === "stock_game" && autoGenerateData && selectedStockIds.length === 0) {
      alert(
